...
class mssm_xs_tools{
 ...
 public:
  ...
  /// Get mA for a given value of mass for a fixed value of tanb. The parameter mass can stand for h, H or Hp, the meaning is determined from the parameter boson
  ...
  double mh(double mphi, double tanb){ return mass("h", mphi, tanb); }
  /// get mh for given value of mphi and tanb (in GeV)
  double mA(double mphi, double tanb){ return mass("A", mphi, tanb); }
  /// get mH+ for given value of mphi and tanb (in GeV)
  ...
  // get total decay width for h  (in GeV)
  double width_h(double mphi, double tanb){ return width("h", mphi, tanb); }
  // get total decay width for h_SM  (in GeV)
  double width_h_SM(double mphi, double tanb){ return width("h_SM", mphi, tanb); }
  //non-CPV and CPV
  // get total decay width for H+  (in GeV)
  ...
  // DeltaB
  // We provide Re(deltab) and Im(deltab) in the coupling group.
  // get the real part of Delta_b -- the name is not re_deltab_b for backward compatibility.
  double re_deltab(double mphi, double tanb){ return coupling("deltab", mphi, tanb); }
  // get the imaginary  part of Delta_b
  double im_deltab(double mphi, double tanb){ return coupling("im_deltab", mphi, tanb); }
  /*
  ...
  /// get BR(h->bb) for given value of mphi and tanb
  double br_hbb(double mphi, double tanb){ return br("h->bb", mphi, tanb); }
  /// get BR(h_SM->bb) for given value of mphi and tanb
  double br_hbb_SM(double mphi, double tanb){ return br("h->bb_SM", mphi, tanb); }
  ...
  /// get BR(h->cc) for given value of mphi and tanb
  double br_hcc(double mphi, double tanb){ return br("h->cc", mphi, tanb); }
  /// get BR(h_SM->cc) for given value of mphi and tanb
  double br_hcc_SM(double mphi, double tanb){ return br("h->cc_SM", mphi, tanb); }
  ...
  /// get BR(h->ss) for given value of mphi and tanb
  double br_hss(double mphi, double tanb){ return br("h->ss", mphi, tanb); }
  /// get BR(h_SM->ss) for given value of mphi and tanb
  double br_hss_SM(double mphi, double tanb){ return br("h->ss_SM", mphi, tanb); }
  ...
  /// get BR(h->uu) for given value of mphi and tanb
  double br_huu(double mphi, double tanb){ return br("h->uu", mphi, tanb); }
  /// get BR(h_SM->uu) for given value of mphi and tanb
  double br_huu_SM(double mphi, double tanb){ return br("h->uu_SM", mphi, tanb); }
  ...
  /// get BR(h->dd) for given value of mphi and tanb
  double br_hdd(double mphi, double tanb){ return br("h->dd", mphi, tanb); }
  /// get BR(h_SM->dd) for given value of mphi and tanb
  double br_hdd_SM(double mphi, double tanb){ return br("h->dd_SM", mphi, tanb); }
  //non-CPV and CPV
  ...
  double br_Hptbb(double mphi, double tanb){ return br("Hp->tb", mphi, tanb); }
  /// get BR(H+->tsb) for given value of mphi and tanb
  double br_Hptsb(double mphi, double tanb){ return br("Hp->ts", mphi, tanb); }
  /// get BR(H+->tdb) for given value of mphi and tanb
  double br_Hptdb(double mphi, double tanb){ return br("Hp->td", mphi, tanb); }
  /// get BR(H+->cbb) for given value of mphi and tanb
  double br_Hpcbb(double mphi, double tanb){ return br("Hp->cb", mphi, tanb); }
  /// get BR(H+->csb) for given value of mphi and tanb
  double br_Hpcsb(double mphi, double tanb){ return br("Hp->cs", mphi, tanb); }
  /// get BR(H+->cdb) for given value of mphi and tanb
  double br_Hpcdb(double mphi, double tanb){ return br("Hp->cd", mphi, tanb); }
  /// get BR(H+->ubb) for given value of mphi and tanb
  double br_Hpubb(double mphi, double tanb){ return br("Hp->ub", mphi, tanb); }
  /// get BR(H+->usb) for given value of mphi and tanb
  double br_Hpusb(double mphi, double tanb){ return br("Hp->us", mphi, tanb); }
  /// get BR(H+->udb) for given value of mphi and tanb
  double br_Hpudb(double mphi, double tanb){ return br("Hp->ud", mphi, tanb); }
  //CPV
  ...
  /// get BR(h->tautau) for given value of mphi and tanb
  double br_htautau(double mphi, double tanb){ return br("h->tautau", mphi, tanb); }
  /// get BR(h_SM->tautau) for given value of mphi and tanb
  double br_htautau_SM(double mphi, double tanb){ return br("h->tautau_SM", mphi, tanb); }
  ...
  double br_hmumu(double mphi, double tanb){ return br("h->mumu", mphi, tanb); }
  /// get BR(h_SM->mumu) for given value of mphi and tanb
  double br_hmumu_SM(double mphi, double tanb){ return br("h->mumu_SM", mphi, tanb); }
  ...
  /// get BR(h->WW) for given value of mphi and tanb
  double br_hWW(double mphi, double tanb){ return br("h->WW", mphi, tanb); }
  /// get BR(h_SM->WW) for given value of mphi and tanb
  double br_hWW_SM(double mphi, double tanb){ return br("h->WW_SM", mphi, tanb); }
  ...
  /// get BR(h->ZZ) for given value of mphi and tanb
  double br_hZZ(double mphi, double tanb){ return br("h->ZZ", mphi, tanb); }
  /// get BR(h_SM->ZZ) for given value of mphi and tanb
  double br_hZZ_SM(double mphi, double tanb){ return br("h->ZZ_SM", mphi, tanb); }
  ...
  /// get BR(h->gg) for given value of mphi and tanb
  double br_hgg(double mphi, double tanb){ return br("h->gluglu", mphi, tanb); }
  /// get BR(h_SM->gg) for given value of mphi and tanb
  double br_hgg_SM(double mphi, double tanb){ return br("h->gluglu_SM", mphi, tanb); }
  ...
  double br_hZgamma(double mphi, double tanb){ return br("h->Zgam", mphi, tanb); }
  /// get BR(h_SM->Zgamma) for given value of mphi and tanb
  double br_hZgamma_SM(double mphi, double tanb){ return br("h->Zgam_SM", mphi, tanb); }
  ...
  /// get BR(h->gammagamma) for given value of mphi and tanb
  double br_hgammagamma(double mphi, double tanb){ return br("h->gamgam", mphi, tanb); }
  /// get BR(h_SM->gammagamma) for given value of mphi and tanb
  double br_hgammagamma_SM(double mphi, double tanb){ return br("h->gamgam_SM", mphi, tanb); }
  //CPV
  ...
  /// get BR(H3->gammagamma) for given value of mphi and tanb
  ...
  /// get BR(H1->gammagamma) for given value of mphi and tanb
  ...
  /// get BR(H->ZA) for given value of mphi and tanb
  double br_HZA(double mphi, double tanb){ return br("H->ZA", mphi, tanb); }
  /// get BR(H->AA) for given value of mphi and tanb
  double br_HAA(double mphi, double tanb){ return br("H->AA", mphi, tanb); }
  /// get BR(H->WmpHpm) for given value of mphi and tanb
  double br_HWHp(double mphi, double tanb){ return br("H->WHp", mphi, tanb); }
  /// get BR(H->AA) for given value of mphi and tanb
  double br_Ahh(double mphi, double tanb){ return br("A->hh", mphi, tanb); }
  /// get BR(A->Zh) for given value of mphi and tanb
  double br_AZh(double mphi, double tanb){ return br("A->Zh", mphi, tanb); }
  /// get BR(A->WmpHpm) for given value of mphi and tanb
  double br_AWHp(double mphi, double tanb){ return br("A->WHp", mphi, tanb); }
...
extern "C" {
  ...
  /// get mass of a given Higgs boson for given values of mphi and tanb (in GeV)
  double mssm_xs_tools_mass2mA(mssm_xs_tools* obj, const char* boson, double mphi, double tanb){
    return obj->mass2mA(boson, mphi, tanb);
  }
