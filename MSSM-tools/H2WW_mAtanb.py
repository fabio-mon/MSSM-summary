...
def recast_limits(source, target, mass_column, limit_column): 
    ...
    with open(source) as f:
        ...
        for l in r:
            contour.append(mA_tanb_scan(float(l[limit_column])/br_2l2n, float(l[mass_column]), 
...
if __name__=="__main__":
    recast_limits("./csv_files/HIG-20-016_obs.csv", "./csv_files/HIG-20-016_mAtanb_obs.csv", "mX", "limit")
    recast_limits("./csv_files/HIG-20-016_exp.csv", "./csv_files/HIG-20-016_mAtanb_exp.csv", "mX", "limit")
